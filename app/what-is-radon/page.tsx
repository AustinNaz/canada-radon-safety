  ...
  return (
    <section className="bg-white text-[#00384a] py-16 px-6 text-center min-h-screen pt-24">
      ...
      <p className="max-w-3xl mx-auto mb-12 text-sm text-gray-800">
        Radon is a naturally occurring radioactive gas that forms from the decay
        ...
        environment and can be found almost everywhere, but it becomes a concern
        when it accumulates to high levels indoors, particularly in enclosed
        spaces like homes, schools, and workplaces.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        <div className="relative bg-gray-100 p-6 rounded">
          ...
          <p className="text-sm text-left">
            ...
            the National Building Code includes radon reduction measures for new
            homes.
          </p>
        </div>
        <div className="relative bg-gray-100 p-6 rounded">
